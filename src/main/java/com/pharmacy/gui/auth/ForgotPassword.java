...
public class ForgotPassword extends JDialog {
	...
	private void confirm() {
		...
		SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
			...
			protected Void doInBackground() throws Exception {
				accountBUS.forgotPassword(empId, email);
				return null;
			}
			...
			protected void done() {
				...
				try {
					...
					verifyOtpDialog = new VerifyOtpDialog(ForgotPassword.this, empId, accountBUS);
					setVisible(false);
	...
	private JDialog createLoadingDialog() {
		...
		dialog.add(lblMessage, java.awt.BorderLayout.NORTH);
