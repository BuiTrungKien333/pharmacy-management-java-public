...
public class VerifyOtpDialog extends JDialog {
	...
	public VerifyOtpDialog(ForgotPassword forgotPassword, String empId, AccountBUS accountBUS) {
	...
	private void verifyOtp() {
		...
		try {
			accountBUS.verifyOTP(empId, otpInput);
			...
			ChangePasswordDialog changePwd = new ChangePasswordDialog(empId, accountBUS);
